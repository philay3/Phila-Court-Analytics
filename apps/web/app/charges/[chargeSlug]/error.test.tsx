...
describe('charge error boundary', () => {
  ...
  it('invokes reset when the retry control is pressed', () => {
    const reset = vi.fn();
    render(<ChargeError error={new Error('boom')} reset={reset} />);
