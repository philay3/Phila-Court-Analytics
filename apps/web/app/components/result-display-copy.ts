...
export const RESULT_DISPLAY_COPY = {
  ...
  // Coverage note (task 30.3; filed criterion added in the final copy pass):
  // rendered in the summary section of both result views, adjacent to the
  // responsible-use notice. States the coverage construction (filed-date and
  // event-date criteria, final outcomes only, ongoing collection); never a
